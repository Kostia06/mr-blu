  ...
  return (
    <div class="flex flex-col gap-4 pb-[100px]">
      ...
      <section class="bg-white/50 backdrop-blur-[20px] rounded-2xl p-5">
        ...
        <div class="flex items-center gap-3.5 p-4 bg-white/60 rounded-xl">
          ...
          <div class="flex-1 min-w-0">
            <p class="text-[15px] font-semibold text-[var(--gray-900,#0f172a)] mb-0.5 mt-0">
      ...
      <section class="bg-white/50 backdrop-blur-[20px] rounded-2xl p-5">
        ...
        <div class="mt-4 pt-4 border-t border-black/[0.06]">
          <div class="flex items-center gap-2">
            <button
              class={`flex-1 flex flex-col items-center justify-center gap-1.5 py-[18px] px-3.5 border-2 rounded-xl text-sm font-semibold cursor-pointer transition-all duration-150 min-h-[80px] relative ${
                targetType === 'estimate'
                  ? sourceDocument.type === 'estimate'
                    ? 'border-[var(--gray-300,#d1d5db)] bg-black/[0.03] text-[var(--gray-500,#64748b)]'
                    : 'border-[var(--blu-primary,#0066ff)] bg-[rgba(0,102,255,0.08)] text-[var(--blu-primary,#0066ff)]'
                  : 'border-transparent bg-white/60 text-[var(--gray-600,#475569)]'
              }`}
            ...
            >
              ...
              {t('review.estimate')}
              {sourceDocument.type === 'estimate' && (
                <span class="text-[10px] font-semibold uppercase tracking-wide text-[var(--gray-400,#94a3b8)] px-1.5 py-0.5 bg-black/5 rounded">
                  {t('review.current')}
                </span>
              )}
            </button>
          ...
          <p class="text-[13px] text-[var(--gray-500,#64748b)] text-center mt-4 mb-0">
      ...
      <section class="bg-white/70 backdrop-blur-[20px] rounded-2xl p-5">
        ...
        <p class="text-sm text-[var(--gray-600,#475569)] mb-4 mt-0 px-3.5 py-3 bg-[rgba(0,102,255,0.05)] rounded-[10px]">
          {summaryText}
        </p>
        ...
        <div class="flex items-center gap-3 p-3.5 bg-white/80 rounded-xl">
          ...
          <div class="flex-1 min-w-0">
            <p class="text-sm font-semibold text-[var(--gray-900,#0f172a)] mb-0.5 mt-0">
      ...
      {/* Action Buttons */}
      <div
        class="fixed bottom-0 left-0 right-0 flex gap-3 px-5 pt-4 bg-white/95 backdrop-blur-[20px] border-t border-black/[0.06] z-[100]"
        style={{ paddingBottom: 'calc(16px + var(--safe-area-bottom, 0px))' }}
      >
        <button
          class="flex items-center justify-center gap-2 px-6 py-4 bg-white/80 border border-black/10 rounded-[14px] text-[15px] font-semibold text-[var(--gray-700,#334155)] cursor-pointer transition-all duration-150 min-h-[56px] disabled:opacity-50 disabled:cursor-not-allowed"
          onClick={onBack}
          type="button"
        ...
        <button
          class={`flex-1 flex items-center justify-center gap-2.5 px-6 py-4 border-none rounded-[14px] text-base font-bold cursor-pointer transition-all duration-200 min-h-[56px] ${
            !isValid || isProcessing
              ? 'bg-[var(--gray-300,#d1d5db)] text-[var(--gray-500,#64748b)] cursor-not-allowed shadow-none'
