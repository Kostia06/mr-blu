    ...
    <div class={cn('flex flex-col gap-1.5', className)}>
      ...
      <div class="relative flex items-center">
        <select
          ...
          required={required}
          class={cn(
            'w-full min-h-12 py-3.5 pl-[18px] pr-11 text-base font-[inherit] text-gray-900 bg-white border border-gray-200 rounded-[var(--radius-sm)] outline-none appearance-none cursor-pointer transition-[border-color,box-shadow] duration-200 ease-in-out',
        ...
        <div
          class={cn(
            'absolute right-3.5 top-1/2 -translate-y-1/2 flex items-center text-gray-400 pointer-events-none transition-transform duration-200 ease-in-out',
            focused && 'rotate-180',
          )}
        >
          <ChevronDown size={18} />
