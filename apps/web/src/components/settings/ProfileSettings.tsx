    ...
    <main class="min-h-screen bg-transparent">
      ...
      <div class="px-[var(--page-padding-x,20px)] max-w-[var(--page-max-width,600px)] mx-auto flex flex-col gap-[var(--section-gap,24px)] pb-[100px]">
        ...
        <FormSection
          ...
          variant="card"
        >
          <div class="flex items-center gap-3.5 py-3.5 px-4 bg-transparent rounded-[var(--radius-input,12px)]">
            <div class="flex items-center justify-center w-11 h-11 bg-[var(--white,#dbe8f4)] rounded-[var(--radius-input,12px)] text-[var(--blu-primary,#0066ff)] shrink-0">
              <Mail size={20} strokeWidth={1.5} />
            </div>
            <div class="flex-1 min-w-0 flex flex-col gap-0.5">
              <span class="text-[15px] font-medium text-[var(--gray-900,#0f172a)] whitespace-nowrap overflow-hidden text-ellipsis">
                {email}
              </span>
              <span class="text-xs text-[var(--gray-500,#64748b)]">
                {t('profile.primaryEmail')}
              </span>
            </div>
            <button
              type="button"
              class="py-2 px-3.5 bg-white/50 border-none rounded-[var(--radius-input,12px)] text-[var(--gray-600,#475569)] text-[13px] font-medium cursor-pointer shrink-0"
          ...
          {showEmailChange && (
            <div class="flex flex-col gap-4 p-4 bg-transparent rounded-[var(--radius-input,12px)] mt-3">
              <FormInput
              ...
              <button
                type="button"
                class={cn(
                  'flex items-center justify-center gap-2 py-3.5 px-5 bg-[var(--blu-primary,#0066ff)] border-none rounded-[var(--radius-button,14px)] text-white text-sm font-semibold cursor-pointer',
